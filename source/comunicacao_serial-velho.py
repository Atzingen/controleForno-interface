...
def serial_read(self):
    try:
        ...
        if texto is not '':											# Caso tenham dados na pilha
            ...
            tipo, d = verifica_dado(texto,self)						# Envia a string recebida para a fun��o que trata os dados
            ################## Sele��o dos tipos de 1 a 8 (ver fun��o verifica_dado)###########################################
            ...
            # Tipo 2 - Liga ou desliga alguma resist�ncia.
                ...
                if d[0] == '2':										# d[0] - Valores de 2 a 7 = as 6 resist�ncias
                    if d[1] == '1':									# d[1] : 1 para ligar e 0 para desligar
                        self.resitencia01 = 100						# Altera o valor da vari�vel de controle da resist�ncia
            ...
            # tipo 8 - Pot�ncia parcial de uma resist6encia
                ...
                if d[0] == '2':										# d[0] - Valores de 2 a 7 - respectivo a cada resist�ncia
                    self.resitencia01 = int(d[1:])					# Altera o valor da vari�vel de controle da resist�ncia
        ...
        self.alerta_toolbar('except - fun��o serial_read ' + str(e))
...
def teste_retorno(self):
    ...
    if not(int(self.ui.horizontalSlider.value()) == self.esteira):				# verifica se h� diferen�a entre a vari�vel e a esteira
    ...
    if not(int(self.ui.horizontalSlider_r01.value()) == self.resitencia01):		# verifica se h� diferen�a entre a vari�vel e a resist�ncia 1
    ...
    if not(int(self.ui.horizontalSlider_r02.value()) == self.resitencia02):		# Idem para resist�ncias 2 a 6
